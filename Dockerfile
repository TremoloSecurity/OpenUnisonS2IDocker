...
RUN chown -R tremoloadmin:tremoloadmin /usr/local/tremolo /etc/openunison /tmp/drivers /usr/local/apache-maven-$MAVEN_VERSION /usr/local/apache-tomcat-$TOMCAT_VERSION /usr/local/bin/mvn
